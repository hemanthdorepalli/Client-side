...
const AdminDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axios.get('https://backend-nodejs-1-i9zy.onrender.com/api/admin/users');
  ...
  useEffect(() => {
    if (selectedUserEmail) {
      const fetchAvailability = async () => {
        try {
          const response = await axios.get(`https://backend-nodejs-1-i9zy.onrender.com/api/admin/availability/${selectedUserEmail}`);
  ...
  const handleUpdateSlot = async () => {
    if (editedSlot) {
      try {
        await axios.put(`https://backend-nodejs-1-i9zy.onrender.com/api/admin/availability/${editedSlot._id}`, {
  ...
  const handleDeleteSlot = async (slotId: string) => {
    try {
      await axios.delete(`https://backend-nodejs-1-i9zy.onrender.com/api/admin/availability/${slotId}`);
  ...
  const handleScheduleSession = async () => {
    ...
    try {
      const response = await axios.post('https://backend-nodejs-1-i9zy.onrender.com/api/slots', { 
      ...
      const availabilityResponse = await axios.get(`https://backend-nodejs-1-i9zy.onrender.com/api/admin/availability/${selectedUserEmail}`);
